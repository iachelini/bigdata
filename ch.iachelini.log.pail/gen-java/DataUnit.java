...
public class DataUnit extends org.apache.thrift.TUnion<DataUnit, DataUnit._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField PAGE_LINK_FIELD_DESC = new org.apache.thrift.protocol.TField("page_link", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE_LINK, new org.apache.thrift.meta_data.FieldMetaData("page_link", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, LinkedEdge.class)));
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case PAGE_LINK:
        ...
        throw new ClassCastException("Was expecting value of type LinkedEdge for field 'page_link', but got " + value.getClass().getSimpleName());
      default:
  ...
  public LinkedEdge getPage_link() {
    if (getSetField() == _Fields.PAGE_LINK) {
      ...
      throw new RuntimeException("Cannot get field 'page_link' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
