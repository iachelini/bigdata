...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>,
	...
	private static final org.apache.thrift.protocol.TField PEDIGREE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"pedigree", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
	private static final org.apache.thrift.protocol.TField DATAUNIT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"dataunit", org.apache.thrift.protocol.TType.STRUCT, (short) 2);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		PEDIGREE((short) 1, "pedigree"), DATAUNIT((short) 2, "dataunit");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.PEDIGREE,
				new org.apache.thrift.meta_data.FieldMetaData("pedigree",
						org.apache.thrift.TFieldRequirementType.REQUIRED,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								Pedigree.class)));
		tmpMap.put(_Fields.DATAUNIT,
				new org.apache.thrift.meta_data.FieldMetaData("dataunit",
						org.apache.thrift.TFieldRequirementType.REQUIRED,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								DataUnit.class)));
	...
	public Data(Pedigree pedigree, DataUnit dataunit) {
		this();
	...
	/**
	 * Returns true if field pedigree is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field dataunit is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(Data other) {
		...
		lastComparison = Boolean.valueOf(isSetPedigree()).compareTo(
				typedOther.isSetPedigree());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPedigree()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.pedigree, typedOther.pedigree);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetDataunit()).compareTo(
				typedOther.isSetDataunit());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDataunit()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.dataunit, typedOther.dataunit);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (pedigree == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'pedigree' was not present! Struct: "
							+ toString());
		}
		if (dataunit == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'dataunit' was not present! Struct: "
							+ toString());
		}
	...
	private static class DataStandardScheme extends StandardScheme<Data> {
		...
		public void read(org.apache.thrift.protocol.TProtocol iprot, Data struct)
				throws org.apache.thrift.TException {
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot,
				Data struct) throws org.apache.thrift.TException {
			struct.validate();
	...
	private static class DataTupleScheme extends TupleScheme<Data> {
		...
		@Override
		public void write(org.apache.thrift.protocol.TProtocol prot, Data struct)
				throws org.apache.thrift.TException {
		...
		@Override
		public void read(org.apache.thrift.protocol.TProtocol prot, Data struct)
				throws org.apache.thrift.TException {
