...
public class PageProperty implements
		org.apache.thrift.TBase<PageProperty, PageProperty._Fields>,
	...
	private static final org.apache.thrift.protocol.TField PROPERTY_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"property", org.apache.thrift.protocol.TType.STRUCT, (short) 2);

	private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
	static {
		schemes.put(StandardScheme.class,
				new PagePropertyStandardSchemeFactory());
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		ID((short) 1, "id"), PROPERTY((short) 2, "property");
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				PageProperty.class, metaDataMap);
	}

	public PageProperty() {
	}

	public PageProperty(PageID id, PagePropertyValue property) {
		this();
		this.id = id;
	...
	/**
	 * Returns true if field property is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(PageProperty other) {
		...
		lastComparison = Boolean.valueOf(isSetProperty()).compareTo(
				typedOther.isSetProperty());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetProperty()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.property, typedOther.property);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (id == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'id' was not present! Struct: "
							+ toString());
		}
		if (property == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'property' was not present! Struct: "
							+ toString());
		}
	...
	private static class PagePropertyStandardSchemeFactory implements
			SchemeFactory {
	...
	private static class PagePropertyStandardScheme extends
			StandardScheme<PageProperty> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				PageProperty struct) throws org.apache.thrift.TException {
	...
	private static class PagePropertyTupleSchemeFactory implements
			SchemeFactory {
	...
	private static class PagePropertyTupleScheme extends
			TupleScheme<PageProperty> {
