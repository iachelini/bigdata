...
public class PersonID extends
		org.apache.thrift.TUnion<PersonID, PersonID._Fields> {
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		COOKIE((short) 1, "cookie"), USER_ID((short) 2, "user_id");
	...
	static {
		...
		tmpMap.put(_Fields.COOKIE,
				new org.apache.thrift.meta_data.FieldMetaData("cookie",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.USER_ID,
				new org.apache.thrift.meta_data.FieldMetaData("user_id",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.I64)));
		metaDataMap = Collections.unmodifiableMap(tmpMap);
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				PersonID.class, metaDataMap);
	}
	...
	protected void checkType(_Fields setField, Object value)
		...
		case COOKIE:
			...
			throw new ClassCastException(
					"Was expecting value of type String for field 'cookie', but got "
		...
		case USER_ID:
			...
			throw new ClassCastException(
					"Was expecting value of type Long for field 'user_id', but got "
							+ value.getClass().getSimpleName());
		default:
	...
	public String getCookie() {
		if (getSetField() == _Fields.COOKIE) {
			...
			throw new RuntimeException(
					"Cannot get field 'cookie' because union is currently set to "
	...
	public long getUser_id() {
		if (getSetField() == _Fields.USER_ID) {
			...
			throw new RuntimeException(
					"Cannot get field 'user_id' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
