...
public class PersonProperty implements
		org.apache.thrift.TBase<PersonProperty, PersonProperty._Fields>,
	...
	static {
		schemes.put(StandardScheme.class,
				new PersonPropertyStandardSchemeFactory());
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				PersonProperty.class, metaDataMap);
	}

	public PersonProperty() {
	}

	public PersonProperty(PersonID id, PersonPropertyValue property) {
		this();
		this.id = id;
	...
	private static class PersonPropertyStandardSchemeFactory implements
			SchemeFactory {
	...
	private static class PersonPropertyStandardScheme extends
			StandardScheme<PersonProperty> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				PersonProperty struct) throws org.apache.thrift.TException {
	...
	private static class PersonPropertyTupleSchemeFactory implements
			SchemeFactory {
	...
	private static class PersonPropertyTupleScheme extends
			TupleScheme<PersonProperty> {
